...
BUILD_ROOT=$ANAKIN_LITE_ROOT/build-android-v8-clang
...
if [ -d $OUT_DIR/android_armv8_clang ];then
	rm -rf $OUT_DIR/android_armv8_clang
	mkdir -p $OUT_DIR/android_armv8_clang
else
    mkdir -p $OUT_DIR/android_armv8_clang
fi

cp -r include/ $OUT_DIR/android_armv8_clang/include
cp -r lib/ $OUT_DIR/android_armv8_clang/lib
cp -r unit_test/ $OUT_DIR/android_armv8_clang/unit_test