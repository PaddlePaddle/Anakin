...
#define __cpuid(LV, A, B, C, D)                         \
    do {                                                \
        ...
        else if (__eax == 0x00000001)                   \
            (A) = 0x000506e3, (B) = 0x01100800,         \
    ...
    do {                                                \
        ...
        if (__eax == 0x00000000)                        \
            ...
            (A) = 0x1c03c163, (B) = 0x03c0003f,         \
                (C) = 0x00001fff, (D) = 0x00000006;     \
        else if (__eax == 4 && __ecx == 4)              \
            (A) = 0x00000000, (B) = 0x00000000,         \
                (C) = 0x00000000, (D) = 0x00000000;     \
        else if (__eax == 7 && __ecx == 0)              \
            (A) = 0x00000000, (B) = 0x029c6fbf,         \
                (C) = 0x00000000, (D) = 0x9c000000;     \
        else if (__eax == 11 && __ecx == 0)             \
            (A) = 0x00000001, (B) = 0x00000002,         \
                (C) = 0x00000100, (D) = 0x00000004;     \
        else if (__eax == 11 && __ecx == 1)             \
            (A) = 0x00000004, (B) = 0x00000008,         \
                (C) = 0x00000201, (D) = 0x00000004;     \
        else if (__eax == 20 && __ecx == 0)             \
            (A) = 0x00000001, (B) = 0x0000000f,         \
                (C) = 0x00000007, (D) = 0x00000000;     \
        else if (__eax == 20 && __ecx == 1)             \
