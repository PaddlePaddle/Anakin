...
#ifdef USE_AMD
template<>
void ConvReluPool<AMD, AK_FLOAT, Precision::FP32>::operator() (
	OpContext<AMD> &ctx, 
    ...
    CUDA_CHECK(cudaPeekAtLastError()); 
    LOG(ERROR) << "over "; */
    auto* impl = static_cast<ConvReluPoolHelper<AMD, AK_FLOAT, Precision::FP32>*>(this->_helper);
    auto& param = static_cast<ConvReluPoolHelper<AMD, AK_FLOAT, Precision::FP32>*>(this->_helper)->_param_conv_relu_pooling;
    impl->_funcs_conv_relu_pooling(ins, outs, param, ctx);
}
#endif
...
template class ConvReluPoolHelper<AMD, AK_FLOAT, Precision::FP16>;
template class ConvReluPoolHelper<AMD, AK_FLOAT, Precision::INT8>;
#endif
