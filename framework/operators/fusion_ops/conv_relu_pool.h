 ...
 */
template<typename Ttype, DataType Dtype, Precision Ptype>
class ConvReluPool : public Operator<Ttype, Dtype, Ptype> {
public:
    ConvReluPool() {}
    ...
    friend class ConvReluPoolHelper<Ttype, Dtype, Ptype>;
};
 ...
 */
template<typename Ttype, DataType Dtype, Precision Ptype>
class ConvReluPoolHelper : public OperatorHelper<Ttype, Dtype, Ptype> {
public:
