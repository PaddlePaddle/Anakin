...
public:
    ...
    saber::ConvActiveParam<Tensor4d<Ttype>>  _param_deconv_batchnorm_scale_relu;
    ///< _funcs_deconv_batchnorm_scale_relu stand for DeconvBatchnormScaleRelu function
    saber::DeconvAct<Ttype, typename PrecisionWrapper<Ptype>::saber_type> _funcs_deconv_batchnorm_scale_relu;
