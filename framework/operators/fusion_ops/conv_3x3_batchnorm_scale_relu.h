...
public:
    ...
    saber::ConvActiveParam<Tensor4d<Ttype>>  _param_conv_batchnorm_scale_relu;
    ///< _funcs_conv_batchnorm_scale_relu stand for SassConvBatchnormScaleRelu function 
    saber::ConvAct<Ttype, typename PrecisionWrapper<Ptype>::saber_type> _funcs_conv_batchnorm_scale_relu;
