...
public:
    ...
    saber::ConvActivePoolingParam<Tensor4d<Ttype>>  _param_conv_relu_pooling;
    ///< _funcs_conv_relu_pooling stand for SassConvReluPool function 
    saber::ConvActPooling<Ttype, typename PrecisionWrapper<Ptype>::saber_type> _funcs_conv_relu_pooling;
