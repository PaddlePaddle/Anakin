...
Status ConvBatchnormScaleReluPoolHelper<Ttype, Ptype>::InitParam() {
    ...
    if (pool_method == "MAX") {
        ...
        LOG(FATAL) << " SassConvBatchnormScaleReluPool fusion op doesn't support : " << pool_method <<
                   " pooling.";
    }
...
ANAKIN_REGISTER_OP_HELPER(ConvBatchnormScaleReluPool, ConvBatchnormScaleReluPoolHelper, X86,
                          Precision::FP32);
#endif
...
ANAKIN_REGISTER_OP_HELPER(ConvBatchnormScaleReluPool, ConvBatchnormScaleReluPoolHelper, NV,
                          Precision::FP32);
ANAKIN_REGISTER_OP_HELPER(ConvBatchnormScaleReluPool, ConvBatchnormScaleReluPoolHelper, NV,
                          Precision::INT8);
#endif
...
ANAKIN_REGISTER_OP_HELPER(ConvBatchnormScaleReluPool, ConvBatchnormScaleReluPoolHelper, ARM,
                          Precision::FP32);
#endif
...
ANAKIN_REGISTER_OP_HELPER(ConvBatchnormScaleReluPool, ConvBatchnormScaleReluPoolHelper, AMD,
                          Precision::FP32);
#endif
//! register op
