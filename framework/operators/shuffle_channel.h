 ...
 */
template<typename Ttype, DataType Dtype, Precision Ptype>
class ShuffleChannel : public Operator<Ttype, Dtype, Ptype> {
public:
    ShuffleChannel() {}
    ...
    virtual void operator() (OpContext<Ttype> &ctx, 
        ...
        LOG(ERROR) << "Not Impl Yet Operator ShuffleChannel<TargetType:"<<"unknown"<<","
                   <<type_id<typename DataTypeWarpper<Dtype>::type>().type_info();
    }

    friend class ShuffleChannelHelper<Ttype, Dtype, Ptype>;
};
 ...
 */
template<typename Ttype, DataType Dtype, Precision Ptype>
class ShuffleChannelHelper : public OperatorHelper<Ttype, Dtype, Ptype> {
public:
...
public:
    ...
    saber::ShuffleChannelParam<Tensor4d<Ttype, Dtype>> _param_shuffle_channel;
    ///< _funcs_shuffle_channel stand for ShuffleChannel function
    saber::ShuffleChannel<Ttype, Dtype> _funcs_shuffle_channel;
};
