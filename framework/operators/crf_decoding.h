...
public:
    ...
    virtual void operator() (OpContext<Ttype> &ctx, 
		...
		LOG(ERROR) << "Not Impl Yet Operator CrfDecoding< Ttype("
...
public:
    ...
    saber::CrfDecodingParam<Tensor4d<Ttype>>  _param_crf_decoding;
    ///< _funcs_crf_decoding stand for CrfDecoding function
    saber::CrfDecoding<Ttype, typename PrecisionWrapper<Ptype>::saber_type> _funcs_crf_decoding;
