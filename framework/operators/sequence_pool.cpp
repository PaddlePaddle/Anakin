...
void SequencePool<X86, Precision::FP32>::operator()(
    ...
    auto& param = static_cast<SequencePoolHelper<X86, Precision::FP32>*>
                  (this->_helper)->_param_sequence_pool;
...
void SequencePool<NV, Precision::FP32>::operator()(
    ...
    auto& param = static_cast<SequencePoolHelper<NV, Precision::FP32>*>
                  (this->_helper)->_param_sequence_pool;
    impl->_funcs_sequence_pool(ins, outs, param, ctx);
}
#endif
