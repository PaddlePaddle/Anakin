...
#ifndef ANAKIN_OPERATOR_EMBEDDING_H
#define ANAKIN_OPERATOR_EMBEDDING_H
...
public:
    ...
    saber::EmbeddingParam<Tensor4d<Ttype>> _param_embedding;
    ///< _funcs_embedding stand for embedding function
    saber::Embedding<Ttype, typename PrecisionWrapper<Ptype>::saber_type> _funcs_embedding;
};
