 ...
 */
template<typename Ttype, Precision Ptype>
class AttensionLstm : public Operator<Ttype,  Ptype> {
public:
    AttensionLstm() {}
    ...
    friend class AttensionLstmHelper<Ttype, Ptype>;
};
 ...
 */
template<typename Ttype,Precision Ptype>
class AttensionLstmHelper : public OperatorHelper<Ttype, Ptype> {
public:
...
public:
    ...
    saber::AttensionLstmParam<Ttype> _param_attension_lstm;
    ///< _funcs_attension_lstm stand for attension_lstm function
    saber::AttensionLstm<Ttype,PrecisionWrapper<Ptype>::saber_type> _funcs_attension_lstm;
};
