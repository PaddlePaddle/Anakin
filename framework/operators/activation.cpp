...
Status ActivationHelper<Ttype, Ptype>::InitParam() {
    ...
    if (type == "TanH") {
        ActivationParam<Tensor4d<Ttype>> param_activation(Active_tanh);
        _param_activation = param_activation;
    } else if (type == "Sigmoid") {
        ActivationParam<Tensor4d<Ttype>> param_activation(Active_sigmoid);
        _param_activation = param_activation;
    } else if (type == "PReLU") {
        ...
        PreluParam<Tensor4d<Ttype>> prelu_param(channel_shared, &(weights.d_tensor()));
        
        ActivationParam<Tensor4d<Ttype>> param_activation(Active_prelu, 0, 0, prelu_param);
        _param_activation = param_activation;
    } else if (type == "Stanh") {
        ActivationParam<Tensor4d<Ttype>> param_activation(Active_stanh);
        _param_activation = param_activation;
    } else if (type == "Relu") {
         ActivationParam<Tensor4d<Ttype>> param_activation(Active_relu);
         _param_activation = param_activation;
    } else if (type == "ClippedRelu") {
         ActivationParam<Tensor4d<Ttype>> param_activation(Active_clipped_relu);
         _param_activation = param_activation;
    } else if (type == "Elu") {
         ActivationParam<Tensor4d<Ttype>> param_activation(Active_elu);
         _param_activation = param_activation;
    } else {
...
template<typename Ttype, Precision Ptype>
Status ActivationHelper<Ttype, Ptype>::InferShape(const
