                ...
                if (merge_node_list.size() > 1){
                    ...
                    for (auto& merge_node : merge_node_list){
                        ...
                        for (int i=0; i < node_arc_out_its.size(); ++i){
                            ...
                            if (std::find(top_node_names.begin(), top_node_names.end(), node_arc_out_its[i]->top()) == top_node_names.end()){
                    ...
                    for (auto& merge_node : merge_node_list){
                        ...
                        for (int i=0; i < node_arc_in_its.size(); ++i){
                            ...
                            if (std::find(in_node_names.begin(), in_node_names.end(), node_arc_in_its[i]->bottom()) == in_node_names.end()){
