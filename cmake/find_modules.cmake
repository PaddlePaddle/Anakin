...
macro(anakin_find_protobuf)
	if(USE_ARM_PLACE)
		...
		if(BUILD_SHARED)
			list(APPEND PROTOBUF_LIBRARIES ${ARM_RPOTO_ROOT}/lib/libprotobuf.so)
		else()
			list(APPEND PROTOBUF_LIBRARIES ${ARM_RPOTO_ROOT}/lib/libprotobuf.a)
		endif()
		#list(APPEND PROTOBUF_LIBRARIES ${ARM_RPOTO_ROOT}/lib/libprotobuf-lite.a)
		#list(APPEND PROTOBUF_LIBRARIES ${ARM_RPOTO_ROOT}/lib/libprotoc.a)
...
macro(anakin_find_openmp)
	...
	if(OPENMP_FOUND OR OpenMP_CXX_FOUND)
		...
		#list(APPEND ANAKIN_LINKER_LIBS ${OPENMP_LIBRARIES} -fopenmp)
	else()
