...
macro(anakin_find_opencv)
    ...
    if(${ANDROID_ABI} STREQUAL "arm64-v8a")
      LINK_DIRECTORIES(${CMAKE_SOURCE_DIR}/third-party/arm-android/opencv/lib/arm64-v8a/)
    else()
...
macro(anakin_find_bmlib)
    set(BM_ROOT $ENV{BM_ROOT})
    #find_path(BM_ROOT_INCLUDE_DNN bmdnn_api.h ${BM_ROOT}/include/bmdnn)
    find_path(BM_ROOT_INCLUDE_RT bmruntime_interface.h ${BM_ROOT}/include/bmruntime)
    find_path(BM_ROOT_INCLUDE_LIB bmlib_runtime.h ${BM_ROOT}/include/bmlib)
    if(BM_ROOT_INCLUDE_RT AND BM_ROOT_INCLUDE_LIB)
        set(BM_FOUND TRUE)
    endif()
    if(BM_FOUND)
