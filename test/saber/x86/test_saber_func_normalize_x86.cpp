...
static SaberStatus test_norm_continue_nchw(int p, bool across_spatial, \
...
#if 0
TEST(TestSaberFuncNormalizeX86, test_func_normalize_ROI_X86) {
    ...
    Prelu<X86, AK_FLOAT> prelu_dev1;
    Prelu<X86, AK_FLOAT> prelu_dev2;
