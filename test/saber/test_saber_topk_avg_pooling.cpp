...
void topk_avg_pooling_basic(const std::vector<Tensor<TargetType_H>*>& inputs,
                            std::vector<Tensor<TargetType_H>*>& outputs, TopKAvgPoolingParam<TargetType_D>& param) {
...
void test_model() {
    ...
    TestSaberBase<TargetType_D, TargetType_H, Dtype, TopKAvgPooling, TopKAvgPoolingParam> testbase(3,
            1);
