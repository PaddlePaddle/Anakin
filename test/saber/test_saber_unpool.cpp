...
void unpool_cpu(const std::vector<Tensor<TargetType_H>*>& input,
...
void create_pooling_index(float* pool_index, int n, int c, int h, int w,
                          PoolingParam<TargetType> param) {
