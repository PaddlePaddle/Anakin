...
void argmax_nv_basic(const std::vector<Tensor<TargetType_H>*>& tensor_in,
                     std::vector<Tensor<TargetType_H>*>& tensor_out, ArgmaxParam<TargetType_D>& param) {
...
void test_model() {
    ...
    for (auto shape : {
        ...
        for (auto param : {
                    argmax1, argmax2, argmax3, argmax4, argmax_param
                }) {
