...
std::string data_path =
    "/home/lxc/projects/models/test_data/sample_by_query_length.expand.sample_url";
...
*/
#ifdef USE_CUDA
int batch_string_to_input(const std::vector<std::string>& line_vec,
                          Net<Target, Precision::FP32, OpRunType::SYNC>& net_executer) {
...
#ifdef USE_X86_PLACE
int batch_string_to_input(const std::vector<std::string>& line_vec,
                          Net<Target_H, Precision::FP32, OpRunType::SYNC>& net_executer) {
...
#ifdef USE_CUDA
int batch_string_to_input(const std::vector<std::string>& line_vec,
                          Net<Target, Precision::FP32>& net_executer) {
...
#ifdef USE_X86_PLACE
int batch_string_to_input(const std::vector<std::string>& line_vec,
                          Net<Target_H, Precision::FP32>& net_executer) {
