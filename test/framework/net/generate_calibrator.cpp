...
std::string model_path =
    "/home/zhangshuai20/workspace/baidu/personal-code/anakin_test/public/alexnet_relu_bn/model/anakin/alexnet_relu_bn.anakin.bin";
...
TEST(NetTest, calibrator) {
    ...
    EntropyCalibrator<NV> entropy_calibrator(&batch_stream, batch_size, calibrator_file, &net_executer,
            bin_num);
