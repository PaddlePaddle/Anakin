...
std::string model_path = "/home/tianxiaogang/txg/fpga/facebox/facebox_origin.anakin.bin";
...
TEST(NetTest, net_execute_base_test) {
    ...
    Net<X86, Precision::FP32, OpRunType::SYNC> net_executer(true);
#else
...
TEST(NetTest, net_execute_reconstruction_test) {
    ...
    // constructs the executer net
    Net<X86, Precision::FP32> net_executer(*graph);
