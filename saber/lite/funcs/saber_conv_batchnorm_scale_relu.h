...
*/
#ifndef ANAKIN_SABER_LITE_FUNCS_SABER_CONV_BATCHNORM_SCALE_RELU_H
#define ANAKIN_SABER_LITE_FUNCS_SABER_CONV_BATCHNORM_SCALE_RELU_H
...
class SaberConvBatchnormScaleRelu {
public:
    SaberConvBatchnormScaleRelu() {
        _conv_op = new SaberConv2D;
    }

    SaberConvBatchnormScaleRelu(int weights_size, int num_output, int group, int kw, int kh, int stride_w, int stride_h, \
        ...
        std::vector<float> scale_w, std::vector<float> scale_b, bool scale_bias_term, ActiveType type, \
...
#endif //ANAKIN_SABER_LITE_FUNCS_SABER_CONV_BATCHNORM_SCALE_RELU_H
