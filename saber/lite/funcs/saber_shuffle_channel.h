...
*/
#ifndef ANAKIN_SABER_LITE_FUNCS_SABER_SHUFFLE_CHANNEL_H
#define ANAKIN_SABER_LITE_FUNCS_SABER_SHUFFLE_CHANNEL_H
...
class SaberShuffleChannel : public OpBase {
public:
    SaberShuffleChannel() {}

    SaberShuffleChannel(ParamBase* param);
...
#endif //ANAKIN_SABER_LITE_FUNCS_SABER_SHUFFLE_CHANNEL_H
