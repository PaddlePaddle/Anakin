...
public:
    ...
    virtual SaberStatus compute_output_shape(const Input_v& input, \
        ...
        Shape new_shape({input_tensor->num(), param.filter_tensor->width(), 1, 1},input[0]->get_layout());
    ...
    virtual SaberStatus init_impl(ImplEnum implenum) override {
        ...
        case VENDER_IMPL:
            this->_impl.push_back(new VenderSequenceConv <TargetType, OpDtype>);
            return SaberSuccess;

        case SABER_IMPL:
            this->_impl.push_back(new SaberSequenceConv <TargetType, OpDtype>);
            return SaberSuccess;
