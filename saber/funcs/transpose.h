...
class Transpose : public BaseFunc<TargetType, OpDtype, ImplBase, TransposeParam>
{
public:
    using BaseFunc<TargetType, OpDtype, ImplBase, TransposeParam >::BaseFunc;
    Transpose() = default;
    ...
    virtual SaberStatus init_impl(ImplEnum implenum) override {
        switch (implenum) { 
            case VENDER_IMPL: 
                this->_impl.push_back(new VenderTranspose <TargetType, OpDtype>); 
                return SaberSuccess; 
            case SABER_IMPL: 
                this->_impl.push_back(new SaberTranspose <TargetType, OpDtype>); 
                return SaberSuccess; 
            default: 
