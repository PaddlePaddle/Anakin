...
#ifndef ANAKIN_SABER_FUNCS_IMPL_CUDA_SABER_POOLING_WITH_INDEX_H
#define ANAKIN_SABER_FUNCS_IMPL_CUDA_SABER_POOLING_WITH_INDEX_H
...
class SaberPoolingWithIndex<NV, OpDtype, inDtype, outDtype, \
...
public:
    ...
    virtual SaberStatus create(const std::vector<DataTensor_in*>& inputs,
                               std::vector<DataTensor_out*>& outputs,
                               PoolingParam<OpTensor> &power_param,
                               Context<NV> &ctx) {
...
template class SaberPoolingWithIndex<NV, AK_FLOAT, AK_FLOAT, AK_FLOAT, NCHW, NCHW, NCHW>;

} //namespace saber

} //namespace anakin

#endif //ANAKIN_SABER_FUNCS_IMPL_CUDA_SABER_POOLING_WITH_INDEX_H