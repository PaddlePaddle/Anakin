...
#ifndef ANAKIN_SABER_FUNCS_IMPL_CUDA_SABER_REVERSE_INPUT_H
#define ANAKIN_SABER_FUNCS_IMPL_CUDA_SABER_REVERSE_INPUT_H
...
class SaberReverseInput<NV, OpDtype> : public ImplBase <
    NV,
    OpDtype,
    EmptyParam<NV >> {
public:
...
private:
    std::vector<OpTensor> _offset_map_cu_vec;
    std::vector<Tensor<NVHX86>> _offset_map_vec;
