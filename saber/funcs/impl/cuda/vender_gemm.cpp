...
template<>
SaberStatus Gemm<NV, VENDER_IMPL, float>::init(const bool trans_a, const bool trans_b,
...
template<>
SaberStatus Gemm<NV, VENDER_IMPL, float>::dispatch(
                     const float alpha, const float* ptr_a,
