...
public:
    ...
    virtual SaberStatus create(const std::vector<Tensor<NV> *>& inputs,
        ...
        CUDA_CHECK(cudaMemcpyAsync(_width_offset_tensor.mutable_data(),width_vector.data(), sizeof(int)*width_vector.size(),cudaMemcpyHostToDevice,this->_ctx->get_compute_stream()));
        return SaberSuccess;
    }
