...
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_RESIZE_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_RESIZE_H
...
class SaberResize<AMD, OpDtype> : public ImplBase<AMD, OpDtype, ResizeParam<AMD>> {
public:
    ...
    virtual SaberStatus dispatch(
        ...
        std::vector<Tensor<AMD>*>& outputs,
        ResizeParam<AMD>& param) override;
...
#endif // ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_RESIZE_H
