...
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_CTC_ALIGN_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_CTC_ALIGN_H
...
class SaberCtcAlign<AMD, OpDtype> : public ImplBase<AMD, OpDtype, CtcAlignParam<AMD>> {
public:
    ...
    virtual SaberStatus dispatch(
            ...
            std::vector<Tensor<AMD>*>& outputs,
            CtcAlignParam<AMD>& param) override;

private:
    AMDKernelPtr _kernel_ctc_align;

    Tensor<AMD> _in_offset;
    Tensor<AMD> _out_offset;
};

template class SaberCtcAlign<AMD, AK_FLOAT>;
} // namespace saber
} // namespace anakin
#endif // ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_CTC_ALIGN_H
