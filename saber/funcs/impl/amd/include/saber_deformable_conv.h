...
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_DEFORMABLE_CONV_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_DEFORMABLE_CONV_H
...
class SaberDeformableConv2D<AMD, OpDtype> : public ImplBase<AMD, OpDtype, ConvParam<AMD>> {
public:
...
#endif // ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_DEFORMABLE_CONV_H
