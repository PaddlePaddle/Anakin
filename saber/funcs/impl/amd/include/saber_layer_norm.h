...
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_LAYER_NORM_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_LAYER_NORM_H
...
class SaberLayerNorm<AMD, OpDtype> : public ImplBase<AMD, OpDtype, LayerNormParam<AMD>> {
public:
    ...
    virtual SaberStatus dispatch(
        ...
        std::vector<Tensor<AMD>*>& outputs,
        LayerNormParam<AMD>& param) override;

private:
    AMDKernelPtr _kernel_ptr_reduce_mean;
    AMDKernelPtr _kernel_ptr_reduce_std;
    AMDKernelPtr _kernel_ptr_normalize_with_scale_bias;
...
#endif // ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_LAYER_NORM_H
