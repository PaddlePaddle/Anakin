...
*/
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_LRN_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_LRN_H
...
class SaberLrn<AMD, OpDtype> : public ImplBase<AMD, OpDtype, LrnParam<AMD>> {
public:
