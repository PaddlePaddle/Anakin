...
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_CAST_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_CAST_H
...
class SaberCast<AMD, OpDtype> : public ImplBase<AMD, OpDtype, CastParam<AMD>> {
public:
    ...
    virtual SaberStatus dispatch(
            ...
            std::vector<Tensor<AMD>*>& outputs,
            CastParam<AMD>& param) override;

private:
    int _inDtype;
    int _outDtype;
    AMDKernelPtr _kernel_cast;
};

template class SaberCast<AMD, AK_FLOAT>;

} // namespace saber
} // namespace anakin
#endif // ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_CAST_H
