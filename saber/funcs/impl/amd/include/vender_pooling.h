...
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_VENDER_POOLING_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_VEMDER_POOLING_H
...
class VenderPooling<AMD, OpDtype> :
        public ImplBase<AMD, OpDtype, PoolingParam<AMD>>
...
public:
    ...
    VenderPooling() { std::cout << "Tony Vendor Pooling init" << std::endl;}
...
#endif // ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_POOLING_H
