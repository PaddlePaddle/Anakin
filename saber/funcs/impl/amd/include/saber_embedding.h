...
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_EMBEDDING_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_EMBEDDING_H
...
class SaberEmbedding<AMD, OpDtype> : public ImplBase<AMD, OpDtype, EmbeddingParam<AMD>> {
public:
    ...
    virtual SaberStatus dispatch(
            ...
            std::vector<Tensor<AMD>*>& outputs,
            EmbeddingParam<AMD>& param) override;

private:
    AMDKernelPtr _kernel_Scale_Embedding;
};
template class SaberEmbedding<AMD, AK_FLOAT>;
} // namespace saber

} // namespace anakin
#endif // ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_EMBEDDING_H
