...
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_VENDER_FC_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_VENDER_FC_H
...
class VenderFc<AMD, OpDtype, inDtype, outDtype,
        ...
        FcParam<Tensor<AMD, OpDtype, LayOutType_op> > >
{
public:
