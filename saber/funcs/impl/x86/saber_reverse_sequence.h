...
#ifndef ANAKIN_SABER_FUNCS_IMPL_X86_SABER_REVERSE_SEQUENCE_H
#define ANAKIN_SABER_FUNCS_IMPL_X86_SABER_REVERSE_SEQUENCE_H
...
class SaberReverseSequence<X86, OpDtype> : public ImplBase<
        X86,
        OpDtype,
        EmptyParam<X86>>
{
