...
class SaberEltwiseActive<X86, OpDtype, inDtype, outDtype,
        ...
        EltwiseActiveParam<Tensor<X86, OpDtype, LayOutType_op> > >
{
public:
...
private:
    ...
    void simple_relu(std::vector<DataTensor_out*>& outputs);
};
