...
#ifndef ANAKIN_SABER_FUNCS_IMPL_X86_JIT_AVX2_CONV_ACT_H
...
class JitAvx2ConvAct : public ImplBase<Tensor<X86, OpDtype, LayOutType_in>,
        Tensor<X86, outDtype, LayOutType_out>,
        Tensor<X86, inDtype, LayOutType_op>,
...
private:
    ...
    jit::jit_avx2_conv_act_kernel *kernel_;
...
#endif // ANAKIN_SABER_FUNCS_IMPL_X86_JIT_AVX2_CONV_ACT_H
