...
SaberStatus SaberPooling<X86, OpDtype>::init(
...
template <DataType OpDtype>
SaberStatus SaberPooling<X86, OpDtype>::create(
        const std::vector<DataTensor_in*>& inputs,
        std::vector<DataTensor_out*>& outputs,
...
template <DataType OpDtype>
SaberStatus SaberPooling<X86, OpDtype>
...
template <DataType OpDtype>
SaberStatus SaberPooling<X86, OpDtype>::init_conf(
