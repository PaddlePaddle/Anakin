...
#ifndef ANAKIN_SABER_FUNCS_IMPL_X86_SABER_ROI_POOL_H
#define ANAKIN_SABER_FUNCS_IMPL_X86_SABER_ROI_POOL_H
...
class SaberRoiPool<X86, OpDtype>:
    public ImplBase<X86, OpDtype, RoiPoolParam<X86>> {
...
template class SaberRoiPool<X86, AK_FLOAT>;
}
