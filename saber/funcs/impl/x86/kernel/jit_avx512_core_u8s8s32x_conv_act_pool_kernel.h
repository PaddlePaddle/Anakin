#ifndef ANAKIN_SABER_FUNCS_IMPL_X86_KERNEL_JIT_AVX512_CORE_U8S8S32X_CONV_ACT_POOL_KERNEL_H
#define ANAKIN_SABER_FUNCS_IMPL_X86_KERNEL_JIT_AVX512_CORE_U8S8S32X_CONV_ACT_POOL_KERNEL_H
...
struct jit_avx512_core_u8s8s32x_conv_act_pool_kernel : public jit_generator {
public:
    jit_avx512_core_u8s8s32x_conv_act_pool_kernel(jit_conv_conf_t ajcp) : jcp(ajcp) {
        generate();
        jit_ker = (void (*)(jit_conv_call_t *))getCode();
    }

    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_avx512_core_u8s8s32x_conv_act_pool_ker_t)
...
private:
    ...
    void generate();
    void store_unit(DataType type_out, zmm_t zmm_in, int aux_output_offset,
                bool mask_flag);
...
#endif // ANAKIN_SABER_FUNCS_IMPL_X86_JIT_AVX512_CORE_U8S8S32_CONV_ACT_POOL_KERNEL_H
