...
struct jit_uni_dw_conv_kernel_f32 : public jit_generator {

public:
    jit_uni_dw_conv_kernel_f32(jit_conv_conf_t ajcp) : jcp(ajcp)
    {
        generate();
        jit_ker = (void (*)(jit_conv_call_t *))getCode();
    }

    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_uni_dw_conv_kernel_f32);
