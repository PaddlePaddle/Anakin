...
void jit_uni_dw_conv_kernel_f32<isa>::load_src(int ur_ch_blocks, int ur_w) {
...
template <cpu_isa_t isa>
void jit_uni_dw_conv_kernel_f32<isa>::apply_filter(
...
template <cpu_isa_t isa>
void jit_uni_dw_conv_kernel_f32<isa>::apply_filter_unrolled(
        int ur_ch_blocks, int ur_w) {
    int ch_blk = jcp.ch_block;
    int dilate_h = jcp.dilate_h + 1;
    int dilate_w = jcp.dilate_w + 1;
...
template <cpu_isa_t isa>
void jit_uni_dw_conv_kernel_f32<isa>::apply_activation(
        int ur_ch_blocks, int ur_w) {
...
template <cpu_isa_t isa>
void jit_uni_dw_conv_kernel_f32<isa>::store_dst(
        int ur_ch_blocks, int ur_w) {
    int ch_blk = jcp.ch_block;
    int repeats = isa == sse42 ? 2 : 1;
    for (int i = 0; i < repeats; i++) {
...
template <cpu_isa_t isa>
void jit_uni_dw_conv_kernel_f32<isa>::loop_body(int ur_ch_blocks) {
...
template <cpu_isa_t isa>
void jit_uni_dw_conv_kernel_f32<isa>::generate() {
    this->preamble();
...
template <cpu_isa_t isa>
SaberStatus jit_uni_dw_conv_kernel_f32<isa>::init_conf(jit_conv_conf_t &jcp){
...
template struct jit_uni_dw_conv_kernel_f32<avx512_common>;
