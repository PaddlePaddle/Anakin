...
template <>
inline void write_gemv_out(const int* in, signed char* out, const float* scale) {
...
SaberStatus gemv_int8(const int8_t* A, const int8_t* x, dtype* y, bool transA, int M, int N, \
    const float* scale, bool is_bias, const int* bias, bool is_relu) {
    if (transA) {
...
#pragma omp parallel for
    for (int j = 0; j < out_cnt; j++) {
        ...
        "prfm  pldl1keep, [%[in]]           \n" /* preload din */
                ...
                "subs %w[cnt], %w[cnt], #1   \n" /* sub main loop count */
                /* add int16 to int32 */
                "saddw  v0.4s, v0.4s, v18.4h \n" /* add low, 4 int16 */
                "saddw  v1.4s, v1.4s, v19.4h \n" /* add low, 4 int16 */
                "saddw  v2.4s, v2.4s, v20.4h \n" /* add low, 4 int16 */
                "saddw  v3.4s, v3.4s, v21.4h \n" /* add low, 4 int16 */
                "saddw  v4.4s, v4.4s, v22.4h \n" /* add low, 4 int16 */
                "saddw  v5.4s, v5.4s, v23.4h \n" /* add low, 4 int16 */
                "saddw  v6.4s, v6.4s, v24.4h \n" /* add low, 4 int16 */
                "saddw  v7.4s, v7.4s, v25.4h \n" /* add low, 4 int16 */
                "saddw2 v0.4s, v0.4s, v18.8h \n" /* add high, 4 int16 */
                "saddw2 v1.4s, v1.4s, v19.8h \n" /* add high, 4 int16 */
                "saddw2 v2.4s, v2.4s, v20.8h \n" /* add high, 4 int16 */
                "saddw2 v3.4s, v3.4s, v21.8h \n" /* add high, 4 int16 */
                "saddw2 v4.4s, v4.4s, v22.8h \n" /* add high, 4 int16 */
                "saddw2 v5.4s, v5.4s, v23.8h \n" /* add high, 4 int16 */
                "saddw2 v6.4s, v6.4s, v24.8h \n" /* add high, 4 int16 */
                "saddw2 v7.4s, v7.4s, v25.8h \n" /* add high, 4 int16 */
                "bne 1b                      \n" /* jump to main loop */
...
#pragma omp parallel for
    for (int j = out_cnt * 4; j < M; j++) {
        ...
        "pld [%[in]]                                @ preload cache line, input\n"
                ...
                "subs %[cnt] , #1                   @ sub loop count \n"
                /* addw int16 + int32 = int32*/
                "vaddw.s16 q0, q0, d2               @ addw \n"
                "vaddw.s16 q0, q0, d3               @ addw \n"
                "bne 1b                             @ jump to main loop\n"
                /* pair add to final result */
                "2:                                 @ end processing\n"
...
template SaberStatus gemv_int8<float>(const int8_t* A, const int8_t* x, float* y, bool transA, int M, int N, \
    const float* scale, bool is_bias, const int* bias, bool is_relu);
template SaberStatus gemv_int8<int>(const int8_t* A, const int8_t* x, int* y, bool transA, int M, int N, \
    const float* scale, bool is_bias, const int* bias, bool is_relu);
template SaberStatus gemv_int8<signed char>(const int8_t* A, const int8_t* x, signed char* y, bool transA, int M, int N, \
    const float* scale, bool is_bias, const int* bias, bool is_relu);
