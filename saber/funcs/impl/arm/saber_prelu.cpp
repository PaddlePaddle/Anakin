...
SaberStatus SaberPrelu<ARM, OpDtype, inDtype, outDtype, \
LayOutType_op, LayOutType_in, LayOutType_out>::dispatch(\
    ...
    const OpDataType* ptr_slope = param.slope->data();
...
template class SaberPrelu<ARM, AK_FLOAT, AK_FLOAT, AK_FLOAT, NCHW, NCHW, NCHW>;
