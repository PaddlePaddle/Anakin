...
#ifndef ANAKIN_SABER_FUNCS_IMPL_ARM_SABER_SHUFFLE_CHANNEL_H
#define ANAKIN_SABER_FUNCS_IMPL_ARM_SABER_SHUFFLE_CHANNEL_H
...
class SaberShuffleChannel<ARM, OpDtype> : \
    public ImplBase<
        ARM,
        OpDtype,
        ShuffleChannelParam<ARM > >
{
public:
    ...
    virtual SaberStatus init(const std::vector<Tensor<ARM> *>& inputs,
                            ...
                            ShuffleChannelParam<ARM>& param, Context<ARM>& ctx) {
        this->_ctx = &ctx;
...
#endif //ANAKIN_SABER_FUNCS_IMPL_ARM_SABER_ShuffleChannel_H
